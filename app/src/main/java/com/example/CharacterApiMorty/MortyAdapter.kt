package com.example.CharacterApiMorty
...
class MortyAdapter(val dataMorty: List<ResultsItem?>?) : RecyclerView.Adapter<MortyAdapter.MyViewHolder>() {
    class MyViewHolder(view: View) :RecyclerView.ViewHolder(view) {
        ...
        val spesiesMorty = view.findViewById<TextView>(R.id.item_spesies_morty)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.spesiesMorty.text = dataMorty?.get(position)?.species
